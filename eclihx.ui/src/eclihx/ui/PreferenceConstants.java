...
//========= haXe Editor Style Settings =========//
	...
	public final static String HX_EDITOR_BRACE_BOLD = "hx_editor_brace_bold";
	...
	public final static String HX_EDITOR_NUMBER_ITALIC = "hx_editor_number_italic";
	...
	public final static String HX_EDITOR_DECLARE_KEYWORDS_ITALIC = "hx_editor_declare_keywords_italic";
	
	public final static String HX_EDITOR_KEYWORDS_COLOR = "hx_editor_keywords_color";
	public final static String HX_EDITOR_KEYWORDS_BOLD = "hx_editor_keywords_bold";
	public final static String HX_EDITOR_KEYWORDS_ITALIC = "hx_editor_keywords_italic";
	...
	public final static String HX_EDITOR_TEMPLATE_COLOR = "hx_editor_template_color";
	public final static String HX_EDITOR_TEMPLATE_BOLD = "hx_editor_template_bold";
	public final static String HX_EDITOR_TEMPLATE_ITALIC = "hx_editor_template_italic";
...
//==============================================//
	...
	public static void initializeDefaultValues(IPreferenceStore store) {
		...
		store.setDefault(HX_EDITOR_MULTILINE_COMMENT_ITALIC, true);
		...
		PreferenceConverter.setDefault(store, HX_EDITOR_KEYWORDS_COLOR, new RGB(0, 0, 102));
		...
		PreferenceConverter.setDefault(store, HX_EDITOR_TEMPLATE_COLOR, new RGB(0, 0, 255));
		store.setDefault(HX_EDITOR_TEMPLATE_BOLD, false);
		store.setDefault(HX_EDITOR_TEMPLATE_ITALIC, false);
		
		PreferenceConverter.setDefault(store, HX_EDITOR_DEFAULT_COLOR, new RGB(0, 0, 0));
