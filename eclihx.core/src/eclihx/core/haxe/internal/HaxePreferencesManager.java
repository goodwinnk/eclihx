...
public class HaxePreferencesManager {
	...
	public static final String PARAM_PREFIX_FLASH_STRICT_FLAG = 
		"--flash-strict";
	public static final String PARAM_PREFIX_NO_TRACES_FLAG = "--no-traces";
	public static final String PARAM_PREFIX_FLASH_USE_STAGE_FLAG = 
		"--flash-use-stage";
	public static final String PARAM_PREFIX_NEKO_SOURCE_FLAG = "--neko-source";
	public static final String PARAM_PREFIX_GENERATE_HAXE_CLASSES_SWF = 
		"--gen-hx-classes";
