 ...
 * generated
 */
public class HXmlExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private static String ID = "eclihx.hxml.HXml";
	private Logger log = Logger.getLogger(HXmlExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		eclihx.hxml.internal.HXmlActivator instance = eclihx.hxml.internal.HXmlActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = eclihx.hxml.internal.HXmlActivator.getInstance().getInjector("eclihx.hxml.HXml");
